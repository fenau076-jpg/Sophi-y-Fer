...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Para mi Rayitoo:\n\nQuería escribirte esta carta porque eres mi persona especial. Desde la primera noche que hablamos, supe que eras tú, que había algo en ti, algo que no quería perderme. \n\nGracias por existir, por estar conmigo, por hacerme feliz y por corresponder mi amor. Contigo entendí que amar es elegir, y yo te elijo a ti todos los días al despertar porque eres increible. \n\nNo sé qué nos espera en el futuro, pero sí sé que me hace feliz imaginar una vida contigo, compartir momentos, sueños y todo lo que venga.\n\nTe queyoooooo mi rayito \n\n Con amor,`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Fernando <3 ";
...
function showCountdown() {
  ...
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('2026-02-28T00:00:00');
